<?php
namespace Elementor_Addon_Learning;

use Custom_Product_Grid;
...
final class Plugin
{
     ...
     * @access private
     * @static
     * @var \Elementor_Addon_Learning\Plugin The single instance of the class.
     */
     ...
     * @access public
     * @static
     * @return \Elementor_Addon_Learning\Plugin An instance of the class.
     */
    ...
    public function register_widgets( $widgets_manager ): void {
		...
		require_once __DIR__ . '/widgets/class-custom-product-grid.php';
		
		$widgets_manager->register( new \Custom_Product_Grid() );
	}
